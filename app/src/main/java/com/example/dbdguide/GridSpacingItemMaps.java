...
public class GridSpacingItemMaps extends RecyclerView.ItemDecoration {

    private final int spanCount;
    private final int spacing;
    private final boolean includeEdge;

    public GridSpacingItemMaps(int spacing, boolean includeEdge) {
        this.spanCount = 2; // Set spanCount to 2 for two items per row
