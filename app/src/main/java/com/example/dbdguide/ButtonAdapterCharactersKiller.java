...
public class ButtonAdapterCharactersKiller extends RecyclerView.Adapter<ButtonAdapterCharactersKiller.ButtonViewHolder> {
    ...
    // Constructor
    public ButtonAdapterCharactersKiller(Context context, List<CharacterItem> buttonItems) {
    ...
    public ButtonViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        ...
        View view = LayoutInflater.from(context).inflate(R.layout.button_item_character_killer, parent, false);
    ...
    private void showPopupWindow(View anchorView, String buttonText, String buttonDescription, String buttonDescription2, int iconResId, CharacterItem characterItem) {
        ...
        View popupView = LayoutInflater.from(context).inflate(R.layout.character_popup_killer, null);
        ...
        if (perkIcons != null && perkIcons.size() >= 3) {
            ...
            List<PerkItem> killerPerks = PerkKillerItemData.getButtonItems();
