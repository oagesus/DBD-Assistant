...
public class CharactersKillerActivity extends AppCompatActivity {

    private ButtonAdapterCharactersKiller buttonAdapterCharactersKiller; // Declare the adapter for buttons
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_characters_killer);
        ...
        // Set the query hint programmatically to "Search killers..."
        searchView.setQueryHint("Search killers...");
        ...
        buttonItems = CharacterKillerItemData.getButtonItems(this);

        // Initialize the adapter and set it to the RecyclerView
        buttonAdapterCharactersKiller = new ButtonAdapterCharactersKiller(this, buttonItems);
        recyclerView.setAdapter(buttonAdapterCharactersKiller);
    ...
    private void applyFilters() {
        ...
        buttonAdapterCharactersKiller.updateItems(filteredItems);
    }
}